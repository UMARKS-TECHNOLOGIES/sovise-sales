  ...
  return (
    <div className='w-full bg-gradient-to-b from-[#eee] to-[#fff]'>
        <div className="w-[90%] m-auto py-10">
              <h3 className="lg:w-[10%] lg:m-auto lg:text-center text-xl py-1 font-bold border-b-slate-400 border-b-2 mb-3">OUR TEAM</h3>
              ...
              <br />
              <p className='lg:text-center'>In Sovise Cook&Bake Academy, our Mantra is a quote by Adrienne Rich, "The most important thing one woman can do for another is to expand her sense of actual possibilities." That's exactly what our team at Sovise Cook&Bake Academy is doing by expanding the possibilities of our students to create wealth for themselves, their families and their communities through their food businesses.</p>
              <div className="w-full py-8 flex flex-col lg:items-center gap-3">
